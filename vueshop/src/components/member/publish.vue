             ...
             <el-col :span="12">
                 ...
                 <el-form :model="video" :rules="rules"  ref="videoForm1" label-width="100px" class="demo-ruleForm">
                     ...
                     <el-form-item label="封面" prop="v_pic">
                         <el-upload
                                 action="http://localhost:9090/web/video/uploadpic"
                                 type="drag"
                                 :thumbnail-mode="true"
                     ...
                     <el-form-item label="上传视频" >
                         <div id="videoContainer" >
                             <el-button id="selectVideo"  v-if="!showProgress" type="primary">选择视频<i class="el-icon-upload el-icon--right"></i></el-button>
        ...
        mounted(){
            ...
            this.uploader = Qiniu.uploader({
                ...
                // uptoken : '<Your upload token>', // uptoken是上传凭证，由其他程序生成
                 uptoken_url: 'http://localhost:9090/web/video/uptoken',         // Ajax请求uptoken的Url，强烈建议设置（服务端提供）
                ...
                domain: 'jtthinkpro',     // bucket域名，下载资源时用到，必需
        ...
        data(){
            ...
            return{
                ...
                video:{
                    ...
                    v_money:0,
                    v_videokey:"", //视频上传到七牛后,且成功后的文件名


                },
                uploadtip:false,//上传完成后显示成功提示
                showVPic:false,
